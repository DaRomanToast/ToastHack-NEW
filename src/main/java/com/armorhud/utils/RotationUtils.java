...
public class RotationUtils {
    public static Vec3d getEyesPos() {
        return RotationUtils.getEyesPos((PlayerEntity) Client.MC.player);
    }
    ...
    public static Vec3d getCwHackLookVec() {
        return RotationUtils.getPlayerLookVec((PlayerEntity) Client.MC.player);
    }
    ...
    public static double getAngleToLookVec(Vec3d vec) {
        return RotationUtils.getAngleToLookVec((PlayerEntity) Client.MC.player, vec);
    }
    ...
    public static void setRotation(Rotation rotation) {
        if (!rotation.isIgnoreYaw()) {
            Client.MC.player.setYaw(rotation.getYaw());
        }
        if (!rotation.isIgnorePitch()) {
            Client.MC.player.setPitch(rotation.getPitch());
        }
    }
